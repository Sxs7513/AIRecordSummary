...
export function buildAppConfig(env: NodeJS.ProcessEnv = process.env): AppConfig {
  return {
    ...
    audio: {
      ...
      qwenAsrLowVolumeRmsThreshold: Number(env.QWEN_ASR_LOW_VOLUME_RMS_THRESHOLD || 0.008),
      qwenAsrLowVolumePeakThreshold: Number(env.QWEN_ASR_LOW_VOLUME_PEAK_THRESHOLD || 0.04),
