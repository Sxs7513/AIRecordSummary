...
export type Transcription = { id: string; recordingId: string; language: string | null; modelName: string; fullText: string; originalFullText: string | null; segmentCount: number; createdAt: string; updatedAt: string };
export type TranscriptionSegment = { id: string; recordingId: string; transcriptionId: string; segmentIndex: number; startMs: number; endMs: number; text: string; originalText: string | null; speakerLabel: string | null; speakerClusterId: string | null; speakerConfidence: number | null; isTargetPerson: boolean; targetPersonConfidence: number | null; diarizationSegmentId: string | null; matchedSpeakerProfileId: string | null; createdAt: string };
