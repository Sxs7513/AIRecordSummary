...
function transcription(value: ApiRecording): Transcription { return { id: String(value.id), recordingId: String(value.recording_id), language: stringOrNull(value.language), modelName: String(value.model_name), fullText: String(value.full_text), segmentCount: Number(value.segment_count), createdAt: String(value.created_at), updatedAt: String(value.updated_at) }; }
