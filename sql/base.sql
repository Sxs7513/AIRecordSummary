...
create index recordings_uploaded_at_idx on recordings (uploaded_at desc);
...
create index speaker_profiles_status_idx on speaker_profiles (status);
...
create index speaker_profile_samples_profile_id_idx on speaker_profile_samples (speaker_profile_id);
create index speaker_profile_samples_status_idx on speaker_profile_samples (status);
...
create index speaker_diarization_segments_recording_id_idx
    on speaker_diarization_segments (recording_id);
create index speaker_diarization_segments_recording_speaker_idx
    on speaker_diarization_segments (recording_id, speaker_cluster_id);
create index speaker_diarization_segments_recording_time_idx
...
create index transcription_segments_recording_id_idx on transcription_segments (recording_id);
create index transcription_segments_transcription_id_idx on transcription_segments (transcription_id);
create index transcription_segments_recording_time_idx
    on transcription_segments (recording_id, start_ms, end_ms);
create index transcription_segments_recording_speaker_idx
    on transcription_segments (recording_id, speaker_cluster_id);
create index transcription_segments_target_person_idx
...
create table processing_jobs (
    ...
    job_type text not null check (
        job_type in ('transcription', 'speaker_diarization', 'speaker_identification')
    ),
...
comment on column processing_jobs.job_type is
    '任务类型。transcription 表示转写，speaker_diarization 表示说话人分离，speaker_identification 表示目标人物识别。';
...
create index processing_jobs_recording_id_idx on processing_jobs (recording_id);
create index processing_jobs_status_idx on processing_jobs (status);
create index processing_jobs_type_status_idx on processing_jobs (job_type, status);
