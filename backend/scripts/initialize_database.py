...
def create_missing_tables(settings: Settings) -> None:
    """Create missing tables and indexes while preserving every existing table."""
...
def initialize_database(settings: Settings) -> None:
    """Create the database and any missing tables without rebuilding existing data."""
    create_database_if_missing(settings)
    create_missing_tables(settings)
