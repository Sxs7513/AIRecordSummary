...
Run it with:
    ...
    PYTHONPATH=backend/src backend/.venv/bin/python -c \
      'import asyncio; from pipeline.example import run_example; print(asyncio.run(run_example()))'
...
from pipeline.contracts import PipelineRunId, PipelineSubjectId, ResourceQueue, RetryPolicy, StageContext, StageResult, StageRunId
