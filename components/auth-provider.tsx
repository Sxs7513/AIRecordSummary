...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  return <div className="shell"><aside className="sidebar"><p className="brand">AI 录音检索</p><nav className="nav"><Link href="/chat">问录音</Link><Link href="/recordings">录音管理</Link><Link href="/asr-lab">ASR Lab</Link><Link href="/rag-evaluation">RAG 评测</Link><Link href="/admin/rag-observability">RAG 监控</Link><Link href="/account">账号</Link></nav></aside><main className="main">{children}</main></div>;
}
